...
import monsterSrc from "../01.png";   // Image 1 — "We Love Us" monster character
import catSrc from "../02.png";           // Image 2 — teal cat sticker character
import boatSrc from "../03.png";         // Image 3 — sailboat kids character (optional)
...
export default function WelcomePage({ onStart }) {
  ...
  return (
    <div style={S.root}>
      ...
      {/* Character — Monster (bottom-left) */}
      <div className="char-wrap flt1" style={{ ...S.charWrap, bottom:80, left:30, width:130 }}>
        <img
          src={monsterSrc}
      ...
      {/* Character — Cat (bottom-right) */}
      <div className="char-wrap flt2" style={{ ...S.charWrap, bottom:80, right:30, width:110 }}>
        <img
          src={catSrc}
          alt="Cat character"
          style={S.charImg}
...
const S = {
  ...
  logoSection: { display:'flex', flexDirection:'column', alignItems:'center', gap:14, marginBottom:22 },
  logoBox: {
  ...
  logoImg: { width:82, height:82, objectFit:'contain', padding:8 },
...
const CSS = `
  ...
  .flt1 { animation: flt1 3.8s ease-in-out infinite; }
  .flt2 { animation: flt2 4.5s ease-in-out 0.8s infinite; }
  @keyframes flt1 { 0%,100%{transform:translateY(0)} 50%{transform:translateY(-16px)} }
  ...
  @media (max-width: 600px) {
    ...
    .char-wrap { display: none !important; }
  }
`;